...
// to avoid tearing: update the video buffer during VBlank
// offset: the number of bytes between the beginning memory block and the memory block of a specific location (indicates index of desired data?)
...
void setPixel(int row, int col, u16 color) {
  int offset = OFFSET(row, col, WIDTH);
